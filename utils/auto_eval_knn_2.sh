...
# python test/nearest_neighbours.py --train_file="/media/alexa/DATA/Miguel/evaluation/ICRA/novel/core50/striplet/lambda_0.1/1/train_set_triplet_cnn_softmax_all_core50.npz" \
#                                   --test_file="/media/alexa/DATA/Miguel/evaluation/ICRA/novel/core50/striplet/lambda_0.1/1/test_set_triplet_cnn_softmax_all_core50.npz"   
...
echo "toybox - novel  0.1"

python test/nearest_neighbours.py --train_file="/media/alexa/DATA/Miguel/evaluation/ICRA/novel/toybox/striplet/lambda_0.1/3/train_set_triplet_cnn_softmax_known_toybox.npz" \
                                  --test_file="/media/alexa/DATA/Miguel/evaluation/ICRA/novel/toybox/striplet/lambda_0.1/3/test_set_triplet_cnn_softmax_known_toybox.npz"   
