...
root_dir =  "/media/alexa/DATA/Miguel/checkpoints/core50/siamese_cnn/"
...
def test(args):
    ...
    np.savez(root_dir + args.split +"_set_siamese_cnn",  embeddings=outputs_embedding, lebels=labels_embedding, filenames=path_imgs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', nargs='?', type=str, default='siamese_cnn', 
    ...
    parser.add_argument('--img_cols', nargs='?', type=int, default=224, 
                        help='Height of the input image')
    parser.add_argument('--batch_size', nargs='?', type=int, default=13, 
                        help='Batch Size')
