...
known_classes_id = {0,1,2,3,4,5,9,11,15,18,19,20,21,22,24,25,26,27,
...
def KNN_precision(args):
    ...
    #npzfile_test = np.load("/media/mikelf/media_rob/experiments/metric_learning/arc/novel/triplet_ae/nby_1/4/x1/test-img/test_set_triplet_ae_arc.npz")
    npzfile_test = np.load(args.test_imgs)
    #=======================================================================================================================

    filename = '/media/mikelf/media_rob/Datasets/arc-novel/ml/test-other-objects-list.txt'

    #test-item_set_cnn_all_avery_binder-item_arc
    ...
    print (label_count)
    print( 100.*correct[0]/(label_count-1) )


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Params')

    parser.add_argument('--test_item_dir', nargs='?', type=str, default="/media/mikelf/media_rob/experiments/metric_learning/arc/novel/triplet_ae/nby_1/1/test-item",
                        help='Path of the input image')
    parser.add_argument('--test_imgs', nargs='?', type=str, default="/media/mikelf/media_rob/experiments/metric_learning/arc/novel/triplet_ae/nby_1/1/test-img/test_set_triplet_ae_arc.npz",
                        help='Path of the input image')
