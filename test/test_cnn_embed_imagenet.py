...
def test(args):
    ...
    print ("Testing CNN imagenet on: ",args.dataset )
    ...
    np.savez(root_dir + args.split + "_set_cnn_imagenet_novel_" + args.dataset,  embeddings=outputs_embedding, lebels=labels_embedding, filenames=path_imgs)
