...
def test(args):
    ...
    root_dir = args.test_path# "/media/mikelf/media_rob/experiments/core50/good/" #"/media/alexa/DATA/Miguel/results/" + args.dataset +"/triplet_cnn/" 
    ...
    np.savez(root_dir + args.split + "_set_triplet_ae_all_" + args.dataset,  embeddings=outputs_embedding, lebels=labels_embedding, filenames=path_imgs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', nargs='?', type=str, default='triplet_ae_test', 
