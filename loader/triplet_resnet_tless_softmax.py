...
class triplet_resnet_tless_softmax(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        lbl_pos = np.array([int(img_path[-11:-9])]) - 1

        lbl_neg = np.array([int(img_path_different[-11:-9])]) - 1
